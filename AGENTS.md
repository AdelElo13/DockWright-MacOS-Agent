...
**Goal:** User enters API key → can chat with Codex → sees streaming response with markdown.
...
- Cost calculation: Codex-sonnet-4-20250514 input=$3/MTok, output=$15/MTok
...
final class AppState {
    ...
    // Settings
    var selectedModel = "Codex-sonnet-4-20250514"
